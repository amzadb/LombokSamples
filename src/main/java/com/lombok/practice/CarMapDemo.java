...
public class CarMapDemo {
	...
	public static void main(String[] args) {
		...
		showCarsByColor(cars);
		System.out.println("---------------------------------------");
		System.out.println();
		showCarsByBrand(cars);
	}

	private static void showCarsByBrand(Collection<Car> cars) {
	...
	private static void showCarsByColor(Collection<Car> cars) {
